...
class MyTestCase(unittest.TestCase):
    ...
    def test_price_under_between_thirty_fifty(self):
        ...
        self.assertAlmostEqual(cc.calculate_price(value_thirty_to_fifty, 5, .1), 19.87 , places=2)
        self.assertAlmostEqual(cc.calculate_price(value_thirty_to_fifty, 5, .15), 19.23 , places=2)
        self.assertAlmostEqual(cc.calculate_price(value_thirty_to_fifty, 5, .2), 18.59 , places=2)
        self.assertAlmostEqual(cc.calculate_price(value_thirty_to_fifty, 10, .1), 15.1 , places=2)
        self.assertAlmostEqual(cc.calculate_price(value_thirty_to_fifty, 10, .15), 14.72 , places=2)
        self.assertAlmostEqual(cc.calculate_price(value_thirty_to_fifty, 10, .20), 14.35, places=2)
